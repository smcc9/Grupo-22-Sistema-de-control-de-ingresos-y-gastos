...
<section class="container">
	...
	<div class="col-md-10">            
            <div class="row">
                <div class="col-md-3">
<p><a href="Controlador_categorias?action=add"><span style="padding-top: 3px; font-size: 20px;" class="icon-circle-with-plus" ></span>Nuevo registro</a></p>                            
                </div>
			...
			<th scope="col"></th>
                    ...
                    <tbody>
                        <c:forEach var="item" items="${categoria}" >
                             ...
                             <td><a href="Controlador_categorias?action=edit&id=${item.id_categoria}">Editar</a></td>
                             <td><a href="Controlador_categorias?action=delete&id=${item.id_categoria}">Eliminar</a></td>
                             </tr>                
                        </c:forEach>
                    </tbody>
		</table>
