			...
			<table class="table table-striped">
			  ...
			  <tbody>
                            <c:set var="montototal" value="${0}"></c:set> 
                             <c:forEach var="item" items="${reporte_vecino}" >
                             ...
                             <td>${item.monto}</td>                             
                             <td><a href="Controlador_ingresos?action=edit_reporte_vecino&id=${item.id_ingreso}">Editar</a></td>
                             <td><a href="Controlador_ingresos?action=delete_reporte_vecino&id=${item.id_ingreso}">Eliminar</a></td>
                             </tr>                
                             </c:forEach>    
			  </tbody>
			</table>
