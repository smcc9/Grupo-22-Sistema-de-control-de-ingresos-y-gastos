...
<p><a href="Controlador_reportes">Volver atras..<span style="text-align: right; padding-top: 3px; font-size: 20px;" class="icon-arrow-with-circle-left" ></span></a></p>                            
			...
			<table class="table table-striped">
			  ...
			  <tbody>
                            <c:set var="montototal" value="${0}"></c:set> 
                             <c:forEach var="item" items="${reporte1}" >
                             ...
                             <td>${item.fecha}</td>
                             <td>${item.monto}</td>                             
                             <td><a href="Controlador_gastos?action=edit_reporte&id=${item.id_gastos}">Editar</a></td>
                             <td><a href="Controlador_gastos?action=delete_reporte&id=${item.id_gastos}">Eliminar</a></td>
                             </tr>                
                             </c:forEach>    
			  </tbody>
			</table>
        ...
        <div class="centro">
            <%--<a class="btn btn-success" href="Controlador_reportes?action=reporte1" target="_blank">IMPRIMIR</a>--%>
        </div>
</section>
</body>
</html>
